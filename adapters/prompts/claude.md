# Claude / Claude Code / Cowork adapter — UW Desk Pipe

Paste this into your Claude / Claude Code / Cowork agent as standing instructions.
...
2. `python3 scripts/wire_adapter.py claude --url 'YOUR_WEBHOOK'`
