# hermes adapter — UW Desk Pipe

Paste this into your hermes agent as standing instructions (skill / system / memory).
...
## Wire-up
1. Create an inbound webhook / wake URL in hermes.
2. Put it in `.env` as `NOTIFY_URL=...`
3. Run: `python3 scripts/wire_adapter.py hermes --url 'YOUR_WEBHOOK'`
