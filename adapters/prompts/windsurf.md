# Windsurf Cascade adapter — UW Desk Pipe

Paste this into your Windsurf Cascade agent as standing instructions.
...
2. `python3 scripts/wire_adapter.py windsurf --url 'YOUR_WEBHOOK'`
