# openclaw adapter — UW Desk Pipe

Paste this into your openclaw agent as standing instructions (skill / system / memory).
...
## Wire-up
1. Create an inbound webhook / wake URL in openclaw.
2. Put it in `.env` as `NOTIFY_URL=...`
3. Run: `python3 scripts/wire_adapter.py openclaw --url 'YOUR_WEBHOOK'`
