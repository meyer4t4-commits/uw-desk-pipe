# ChatGPT / custom GPT actions adapter — UW Desk Pipe

Paste this into your ChatGPT / custom GPT actions agent as standing instructions.
...
2. `python3 scripts/wire_adapter.py chatgpt --url 'YOUR_WEBHOOK'`
