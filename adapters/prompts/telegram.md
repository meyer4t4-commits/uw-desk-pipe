# Telegram bot adapter — UW Desk Pipe

Paste this into your Telegram bot agent as standing instructions.
...
2. `python3 scripts/wire_adapter.py telegram --url 'YOUR_WEBHOOK'`
