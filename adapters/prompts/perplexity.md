# Perplexity agent / computer adapter — UW Desk Pipe

Paste this into your Perplexity agent / computer agent as standing instructions.
...
2. `python3 scripts/wire_adapter.py perplexity --url 'YOUR_WEBHOOK'`
